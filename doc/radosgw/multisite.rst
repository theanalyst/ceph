...
::
   ...
   # radosgw-admin zonegroup create --rgw-zonegroup=us --endpoints=http://rgw1:80 --default
   {
...
If the ``--rgw-zonegroup`` switch wasn't specified during creation, the zone has
to be added to the zonegroup explicitly via the following command::
